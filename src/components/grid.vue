<template>
  <div class="wrapper">
    <div class="box vertical" id="half2">
          ...
          <div class="box horizontal">
            <div class="sketch">
              <iframe
                width="300px"
                height="210px"
                src="https://editor.p5js.org/lanzhang76/embed/Yz-EzEFfc"
              ></iframe>
            </div>
          </div>
...
export default {
  ...
  data() {
    return {
      ...
      emailadd: "mailto:lan@lanzhang.net?Subject=Hello%20Lan",
    };
  },
};
</script>
